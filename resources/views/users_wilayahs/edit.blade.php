...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('users_wilayahs.users_wilayahs.update', $usersWilayahs->wilayah_kerjas_id) }}" id="edit_users_wilayahs_form" name="edit_users_wilayahs_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('users_wilayahs.form', [
                                        'usersWilayahs' => $usersWilayahs,
                                      ])
