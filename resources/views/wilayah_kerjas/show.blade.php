...
<div class="panel panel-default">
    <div class="panel-heading clearfix">
        ...
        <span class="pull-left">
            <h4 class="mt-5 mb-5">{{ isset($title) ? $title : 'Wilayah Kerjas' }}</h4>
        </span>
    ...
    <div class="panel-body">
        <dl class="dl-horizontal">
            <dt>Jenis</dt>
            <dd>{{ $wilayahKerjas->jenis }}</dd>
            <dt>Nama</dt>
            <dd>{{ $wilayahKerjas->nama }}</dd>
            <dt>Created At</dt>
            <dd>{{ $wilayahKerjas->created_at }}</dd>
            <dt>Updated At</dt>
            <dd>{{ $wilayahKerjas->updated_at }}</dd>
