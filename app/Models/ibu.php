...
class ibu extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['id', 'nama', 'tgl_lahir', 'no_hp', 'alamat', 'wilayah_kerjas_id', 'id_telegram'];
    ...
    {
        return $this->hasOne('App\Models\anak', 'ibus_id', 'id');
    }

    /**
     * Get the riwayatPesan for this model.
     *
     * @return App\Models\RiwayatPesan
     */
